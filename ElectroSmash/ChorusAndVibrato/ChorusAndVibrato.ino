...
// pedalshield_mega_chorus_and_vibrato.ino You can choose between chorus and vibrato using the toogle switch.
...
void loop() 
{
 ...
 do {
   ...
   if (digitalRead(TOGGLE))u8g.drawStr( 0, 20, " VIBRATO "); 
   else u8g.drawStr( 0, 20, " CHORUS "); 
