...
#define MAX_DELAY1 3100
#define MAX_DELAY2  400
#define MAX_DELAY3  75

unsigned int DelayBuffer1[MAX_DELAY1];
unsigned int DelayBuffer2[MAX_DELAY2];
unsigned int DelayBuffer3[MAX_DELAY3];
...
ISR(TIMER4_CAPT_vect) 
{
  ...
  DelayBuffer1[DelayCounter1] = ((((ADC_high << 8) | ADC_low) + 0x8000)+DelayBuffer1[DelayCounter1])>>1;
  DelayBuffer2[DelayCounter2] = ((((ADC_high << 8) | ADC_low) + 0x8000)+DelayBuffer1[DelayCounter2])>>1;
  DelayBuffer3[DelayCounter3] = ((((ADC_high << 8) | ADC_low) + 0x80000)+DelayBuffer1[DelayCounter3])>>1;
...
//the output signal is = delayed signal + current signal.
  input = (DelayBuffer1[DelayCounter1]+DelayBuffer2[DelayCounter2]+DelayBuffer3[DelayCounter3]+(((ADC_high << 8) | ADC_low) + 0x8000))>>2;
